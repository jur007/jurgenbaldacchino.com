...
export const showcaseProjects: IProject[] = [
  {
    ...
    summary:
      "Architected and scaled the flagship crypto casino web app from initial inception to high-volume production, keeping UI renders fluid and wallet balances synced in real time.",
    whatIDid: [
      "Led frontend architecture from day zero and established coding standards across the engineering team.",
      "Built fast, reactive casino interfaces with instant multi-currency wallet updates and live sports betting feeds.",
      "Automated CI/CD pipelines and deployment guardrails to ship product features quickly with zero downtime.",
    ],
    howIBuiltIt: [
      "Decoupled high-frequency balance tickers into a dedicated reactive state layer so live data never blocks UI rendering.",
      "Implemented aggressive code splitting and asset preloading to deliver sub-second initial load times across global edge networks.",
    ],
  ...
  },
  {
    ...
    summary:
      "A custom 2D casual game built from scratch as an isolated standalone bundle with smooth animations, physics, and quick load times.",
    whatIDid: [
      "Built the full 2D interactive canvas game loop, particle effects, and sprite animations using Phaser 3.",
  ...
  },
  {
    ...
    metrics: "High-volume match day reliability",
  ...
  },
  {
    ...
    metrics: "Fast onboarding & zero layout shift",
