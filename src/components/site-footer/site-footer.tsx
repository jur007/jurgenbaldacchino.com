...
const LinkedInIcon = () => (
  <svg aria-hidden="true" className={styles.socialIcon} fill="currentColor" viewBox="0 0 24 24">
    <path d="M5.3 7.9H1.8V22h3.5V7.9ZM3.5 2A2 2 0 1 0 3.5 6a2 2 0 0 0 0-4ZM22 13.9c0-4.3-2.3-6.3-5.4-6.3a4.7 4.7 0 0 0-4.2 2.3v-2H8.9V22h3.5v-7c0-1.8.3-3.6 2.6-3.6s2.3 2.1 2.3 3.7V22H22v-8.1Z" />
  </svg>
)
